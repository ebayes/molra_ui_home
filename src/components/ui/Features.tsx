...
export default function Features() {
  return (
    ...
    >
      ...
      Our XPRIZE solution leverages careful groundwork for quantitatively linking up geographic scales of observation with human-in-the-loop machine learning to deliver comprehensive local biodiversity information and support conservation insights. 
      </p>
