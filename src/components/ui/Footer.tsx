...
const navigation = {
  map: [
    { name: "Species", href: "https://mol.org/species/", external: true },
    { name: "Regions", href: "https://mol.org/regions/", external: true },
    { name: "Indicators", href: "https://mol.org/indicators/", external: true },
    { name: "Patterns", href: "https://mol.org/patterns/", external: true },
    { name: "Datasets", href: "https://mol.org/datasets/", external: true },
  ],
  resources: [
    { name: "GitHub", href: "https://github.com/JetzLab", external: true },
    { name: "Twitter", href: "https://x.com/moldotorgb", external: true },
  ],
  team: [
    { name: "About", href: "/about", external: false },
    { name: "Press", href: "https://mol.org/press", external: true },
    { name: "Blog", href: "https://mol.org/blog", external: true },
    { name: "Careers", href: "https://mol.org/careers", external: true },
  ],
  legal: [
    { name: "Privacy", href: "https://mol.org/privacy", external: true },
    { name: "Terms", href: "https://mol.org/tos", external: true },
  ],
}
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-20">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-600 dark:text-gray-400">
              Redefining the way biodiversity data is collected, managed, and
              analyzed.
            </p>
