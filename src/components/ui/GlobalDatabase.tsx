  ...
  const features = [
    {
      ...
      description: "Machine learning and eDNA tools enable automated species detection.",
    },
    {
      name: "Global Species Data",
      description: "Platform powered by insight from Map of Life biodiversity data.",
    },
    {
      name: "Local Knowledge",
      description:
        "Tools enable local and indigenous communities to protect biodiversity.",
    },
  ]
  ...
  return (
    <div className="px-3">
      ...
      >
        ...
        >
          The global <br /> biodiversity database
        </h2>
        <canvas
