      ...
      <div className="mt-20">
        ...
        <div className="mt-8 hidden w-full justify-between gap-4 md:flex">
          <InstaxImage
            ...
            width={640}
            height={360}
            caption="Manuel, Jayden, and Walter reviewing a flight"
          />
          <InstaxImage
            ...
            width={640}
            height={965}
            caption="Inspecting an eDNA sample"
          />
          <InstaxImage
            ...
            width={1920}
            height={1281}
            caption="Alex and John launching the big drone."
          />
        </div>
      </div>
      <div className="mt-28">
